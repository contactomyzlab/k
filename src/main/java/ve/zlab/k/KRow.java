...
public class KRow {
    ...
    public KRow assertNotNull(final String c, final Response.Status status, final String message) throws KException {
        if (this.isNull) {
    ...
    public KRow assertNotNull(final int n, final Response.Status status, final String message) throws KException {
        if (this.isNull) {
            throw new KException(status, message);
        }
    ...
    public KRow assertNotNull(final String c, final Response.Status status) throws KException {
        return assertNotNull(c, status, null);
    }
    
    public KRow assertNotNull(final int n, final Response.Status status) throws KException {
    ...
    public KRow assertNotNull(final Response.Status status, final String message) throws KException {
        if (this.isNull) {
            throw new KException(status, message);
        }
    ...
    public KRow assertNotNull(final Response.Status status) throws KException {
        return assertNotNull(status, null);
    }
    
    public Response buildResponse() {
        return Response.ok(this.toResponse()).build();
    }
