...
public class GenericDAK {
    ...
    public static void assertRecordExists(
        ...
        GenericDAK.assertRecordExists(K, table, id, Response.Status.NOT_FOUND, "Record not found");
    }
    ...
    public static void assertRecordExists(
        ...
        assertRecordExists(K, table, id, WherePropertyHelper.group(whereProperty), Response.Status.NOT_FOUND, "Record not found");
    }
    ...
    public static void assertRecordExistsNotDeleted(
        ...
        GenericDAK.assertRecordExistsNotDeleted(K, table, id, Response.Status.NOT_FOUND, "Record not found");
    }
    ...
    public static void assertRecordExistsNotDeletedAndActive(
        ...
        GenericDAK.assertRecordExistsNotDeletedAndActive(K, table, id, Response.Status.NOT_FOUND, "Record not found");
    }
