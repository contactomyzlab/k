...
public class MyCustomer extends KModel {
    ...
    final static Class<? extends KModelDTO> E = MyCustomerDTO.class;

    public static String ID = c(E, MyCustomerDTO.ID);

    public static String ID(final String alias) {
        return alias(ID, alias);
    }

    public static String NAME = c(E, MyCustomerDTO.NAME);

    public static String NAME(final String alias) {
        return alias(NAME, alias);
    }

    public static String LAST_NAME = c(E, MyCustomerDTO.LAST_NAME);
