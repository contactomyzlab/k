...
public class MyBook extends KModel {
    ...
    final static Class<? extends KModelDTO> E = MyBookDTO.class;

    public static String ID = c(E, MyBookDTO.ID);

    public static String ID(final String alias) {
        return alias(ID, alias);
    }

    public static String NAME = c(E, MyBookDTO.NAME);

    public static String NAME(final String alias) {
        return alias(NAME, alias);
    }

    public static String MY_CUSTOMER_ID = c(E, MyBookDTO.MY_CUSTOMER_ID);
