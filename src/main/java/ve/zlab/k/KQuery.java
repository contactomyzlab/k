...
//        final Query query = entityManager.createNativeQuery(String.format("SELECT EXISTS(%s)", ql));
     ...
     */
    public void assertExists(final Response.Status status) throws KException {
     ...
     * @throws ve.zlab.k.KException If the resulting value (Boolean) of evaluating the EXISTS function in the generated SQL query is false 
     */
    public void assertExists(final Response.Status status, final String message) throws KException {
        this.select("1");
...
//        final Query query = entityManager.createNativeQuery(String.format("SELECT EXISTS(%s)", ql));
        ...
        try {
            ...
            throw new KException(Response.Status.INTERNAL_SERVER_ERROR);
        }
     ...
     * @throws ve.zlab.k.KException If the resulting value (Boolean) of evaluating the EXISTS function in the generated SQL query is false 
     */
    public void assertNotExists(final Response.Status status) throws KException {
     ...
     * @throws ve.zlab.k.KException If the resulting value (Boolean) of evaluating the EXISTS function in the generated SQL query is false 
     */
    public void assertNotExists(final Response.Status status, final String message) throws KException {
        this.select("1");
...
//        final Query query = entityManager.createNativeQuery(ql);
    ...
    public int update(final Map<String, Object> d, final HashMap<String, String> processors) throws KException {
        if (whereNullsCount > 0) {
            throw new KException(Response.Status.INTERNAL_SERVER_ERROR, "The query cannot be executed for protection. A condition has a null value");
        }
...
//        final Query query = entityManager.createNativeQuery(ql);
    ...
    public int update(final List<Map<String, Object>> fromValues, final String[] fromColumns, final Map<String, Object> d, final HashMap<String, String> processors) throws KException {
        if (whereNullsCount > 0) {
            throw new KException(Response.Status.INTERNAL_SERVER_ERROR, "The query cannot be executed for protection. A condition has null value");
        }
