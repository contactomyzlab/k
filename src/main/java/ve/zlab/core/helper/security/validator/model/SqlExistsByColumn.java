...
public class SqlExistsByColumn extends KRule {
    ...
    public void validate(final KExecutor K, final Object value) throws KException {
        if (K == null) {
            throw new KException(Response.Status.INTERNAL_SERVER_ERROR, "K reference is mandatory -- SqlExistsByColumn");
        }
        ...
        kQuery.assertExists(Response.Status.BAD_REQUEST, message);
    }
